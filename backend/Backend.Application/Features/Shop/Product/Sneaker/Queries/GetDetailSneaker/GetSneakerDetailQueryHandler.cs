...
public class GetSneakerDetailQueryHandler
    : IRequestHandler<GetSneakerDetailQuery, GetSneakerDetailResult>
{
    private readonly IUnitOfWork _unitOfWork;

    public GetSneakerDetailQueryHandler(IUnitOfWork unitOfWork)
    {
        _unitOfWork = unitOfWork;
    }

    public async Task<GetSneakerDetailResult> Handle(
        GetSneakerDetailQuery query,
