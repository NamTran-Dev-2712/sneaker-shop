...
interface SneakerListToolbarProps {
  search: string;
  sortBy: string;
  sortOrder: string;
...
export const SneakerListToolbar = memo(function SneakerListToolbar({
  search,
  sortBy,
  sortOrder,
  hasActiveFilters,
...
export default SneakerListToolbar;
